  ...
  useEffect(() => {
    ...
    if (dateRange !== 'all') {
        ...
        if (dateRange === 'past 3months'){
            ...
            filtered = filtered.filter(launch => new Date(launch.launch_date_utc) >= pastDate && new Date(launch.launch_date_utc) <= presentDate);
        }
  ...
  return (
    <div>
      ...
      <div>
        ...
        <select title='date' value={dateRange} onChange={e => {
